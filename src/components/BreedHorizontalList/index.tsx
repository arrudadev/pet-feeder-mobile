...
export function BreedHorizontalList() {
  ...
  return (
    <Container>
      <FlatList
        data={breeds}
        keyExtractor={breed => String(breed.id)}
